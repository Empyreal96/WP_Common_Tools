...
namespace Microsoft.CompPlat.PkgBldr.Tools
{
	public class DirectoryAcl : ResourceAcl
	{
		...
		public DirectoryAcl(string directory, string rootPath)
		{
			...
			{
				throw new DirectoryNotFoundException(string.Format(CultureInfo.InvariantCulture, "Folder {0} cannot be found", new object[1] { directory }));
			}
		...
		private void Initialize(DirectoryInfo di, string rootPath)
		{
			...
			m_path = LongPath.Combine("\\", di.FullName.Remove(0, rootPath.Length)).ToUpperInvariant();
		}
	}
}
